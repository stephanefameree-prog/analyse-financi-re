...
FUNDAMENTALS_LABELS = {
    ...
    "Juste valeur estimée": "Juste valeur estimée (/ action)",
    "Écart juste valeur": "Écart juste valeur (/ action, JV − cours)",
    "Upside juste valeur": "Upside juste valeur (%)",
    "Juste valeur Damodaran": "Juste valeur Damodaran (/ action)",
    "Upside Damodaran": "Upside Damodaran (%)",
    "Profil Damodaran": "Profil Damodaran",
    "Libellé juste valeur": "Libellé juste valeur",
    "Modèle juste valeur": "Modèle juste valeur",
...
WATCHLIST_LABELS = {
    ...
    "Dividende / action": "Dividende / action (/ action, TTM Yahoo)",
    "Upside vs objectif": "Upside vs objectif (%)",
    "RSI": "RSI (0–100)",
...
WATCHLIST_FORMAT = {
    ...
    "Rendement dividende": "{:.2%}",
    "Dividende / action (/ action, TTM Yahoo)": "{:.2f}",
    "Dividende / action": "{:.2f}",
...
TECHNICAL_LABELS = {
    ...
    "Valeur échangée": "Valeur échangée (devise cotation)",
    "Val / Moy. 20j": "Valeur / moy. 20j (×)",
    "MFI": "MFI (0–100)",
    "SMA 50": "SMA 50 (/ action)",
    "SMA 200": "SMA 200 (/ action)",
    "SuperTrend": "SuperTrend (/ action)",
    "Bollinger %B": "Bollinger %B (0–1)",
    "ATR": "ATR (/ action)",
    "ATR/Prix": "ATR / Prix (%)",
}
...
TECHNICAL_FORMAT = {
    ...
    "Volume / moy. 20j (×)": "{:.2f}×",
    "Vol / Moy. 20j": "{:.2f}×",
    "Valeur échangée (devise cotation)": "{:,.0f}",
    "Valeur échangée": "{:,.0f}",
    "Valeur / moy. 20j (×)": "{:.2f}×",
    "Val / Moy. 20j": "{:.2f}×",
    "MFI (0–100)": "{:.1f}",
...
SUGGESTIONS_LABELS = {
    ...
    "Plus-value latente 1 sem.": "Plus-value latente 1 sem. (%)",
    "Plus-value latente 1 mois": "Plus-value latente 1 mois (%)",
    "Plus-value latente 1 an": "Plus-value latente 1 an (%)",
    "Volatilité candidat": "Volatilité candidat (%)",
    "Skewness candidat": "Skewness candidat",
    "Kurtosis candidat": "Kurtosis candidat",
    "Sharpe candidat": "Sharpe candidat (×)",
    ...
    "Δ Sharpe portef.": "Δ Sharpe portef. (×)",
...
SUGGESTIONS_FORMAT = {
    ...
    "Rendement candidat": "{:.2%}",
    "Plus-value latente 1 sem. (%)": "{:.2%}",
    "Plus-value latente 1 sem.": "{:.2%}",
    "Plus-value latente 1 mois (%)": "{:.2%}",
    "Plus-value latente 1 mois": "{:.2%}",
    "Plus-value latente 1 an (%)": "{:.2%}",
    "Plus-value latente 1 an": "{:.2%}",
